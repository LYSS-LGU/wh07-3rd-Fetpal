...
erDiagram
    ...
    "userPals" {
        UUID id PK
        UUID userId FK "FK: profiles.id"
        UUID palId FK "FK: palProfiles.palId"
        TEXT relationship
        TIMESTAMP createdAt
    }
    ...
    "palVaccinations" {
        UUID id PK
        UUID palId FK "FK: palProfiles.palId"
        INTEGER vaccinationTypeId FK "FK: vaccinationTypes.id"
        INTEGER shotNumber
        DATE scheduledDate
        DATE actualDate
        ...
        BOOLEAN isRequired
        TIME scheduleTime
        UUID plannerEventId FK "FK: plannerEvents.id"
        TIMESTAMP createdAt
        TIMESTAMP updatedAt
    }
    ...
    "palVaccinationSummary" {
        UUID id PK
        UUID palId UK "FK: palProfiles.palId"
    ...
    "plannerEventTags" {
        UUID id PK
        UUID eventId FK "FK: plannerEvents.id"
        TEXT tagName
        TIMESTAMP createdAt
    }
    ...
    "plannerExpenseTags" {
        UUID id PK
        UUID expenseId FK "FK: plannerExpenses.id"
        TEXT tagName
        TIMESTAMP createdAt
    }
    
    "plannerEventHashtags" {
        UUID eventId PK "FK: plannerEvents.id"
        INTEGER hashtagId PK "FK: globalHashtags.id"
        TIMESTAMP createdAt
    }
    
    "plannerExpenseHashtags" {
        UUID expenseId PK "FK: plannerExpenses.id"
        INTEGER hashtagId PK "FK: globalHashtags.id"
        TIMESTAMP createdAt
    }
    ...
    "postlikes" {
        UUID id PK
        UUID postid FK "FK: communityposts.id"
        UUID userid FK "FK: profiles.id"
        TIMESTAMP createdat
    }
    ...
    "postcomments" {
        ...
        TEXT authorimage
        TEXT content
        UUID parentcommentid FK "FK: postcomments.id"
        INTEGER likescount
        BOOLEAN isedited
        TIMESTAMP editedat
        TIMESTAMP createdat
    ...
    "commentlikes" {
        UUID id PK
        UUID commentid FK "FK: postcomments.id"
        UUID userid FK "FK: profiles.id"
        TIMESTAMP createdat
    }
    
    "communityPostHashtags" {
        UUID postId PK "FK: communityposts.id"
        INTEGER hashtagId PK "FK: globalHashtags.id"
        TIMESTAMP createdAt
    }
    ...
    "lifestylechatrooms" {
        ...
        TEXT hashtagname
        TEXT description
        UUID createdby FK "FK: profiles.id"
        BOOLEAN isactive
    ...
    "lifestylechatmessages" {
        UUID id PK
        UUID roomid FK "FK: lifestylechatrooms.roomid"
        UUID userid FK "FK: profiles.id"
        TEXT content
        TEXT[] imageurls
        TEXT messagetype
    ...
    "lifestylechatmessagehashtags" {
        UUID messageid PK "FK: lifestylechatmessages.id"
        INTEGER hashtagid PK "FK: globalHashtags.id"
        TIMESTAMP createdat
    }
...
- **작성자**: 석이 + Claude
- **버전**: v4.0 (4차 스프린트)
- **이전 문서**: [251114_04_시스템_아키텍처.md](./251114_04_시스템_아키텍처.md)
- **다음 문서**: [251114_06_요구사항_정의서.md](./251114_06_요구사항_정의서.md)
